...
# ================================================================
# 📊 ACDT Group 31 Final Streamlit App (Local CSV Auto Load Version)
# ================================================================
...
def load_and_preprocess_data():
    """
    Loads the CSV dataset from the repository and preprocesses it.
    - Removes non-numeric characters
    - Converts to numeric where possible
    - Drops invalid rows
    """
    try:
        # Load the dataset directly from the repository
        ...
        st.error("❌ Data file not found. Please ensure it exists in your repository.")
        return pd.DataFrame()
...
st.markdown("""
This interactive Streamlit dashboard performs:
